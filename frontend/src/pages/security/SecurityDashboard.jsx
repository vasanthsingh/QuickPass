...
const buildPhotoUrl = (photoPath) => {
    ...
    return `${serverBase}${photoPath.startsWith('/') ? photoPath : `/${photoPath}`}`
}
                                    ...
                                    {details ? (
                                        <div className="result-meta">
                                            {details.student?.profilePhotoUrl ? (
                                                <img
                                                    src={buildPhotoUrl(details.student.profilePhotoUrl)}
                                                    alt={`${details.student?.fullName || 'Student'} profile`}
                                                    style={{ width: '110px', height: '110px', borderRadius: '10px', objectFit: 'cover', marginBottom: '10px' }}
                                                />
                                            ) : null}
